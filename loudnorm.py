...
import json 
iteration = 0
print(len(os.listdir(".")), "Files Found")
for i in os.listdir("."):
    iteration += 1
    print(iteration, ":")
    ...
    outflags = '-f wav -af loudnorm=measured_I=' + loudstats['input_i'] + ":measured_TP=" + loudstats['input_tp'] + ":measured_LRA=" + loudstats['input_lra'] + ":measured_thresh=" + loudstats['input_thresh'] + ":offset=" + loudstats['target_offset'] + ":print_format=summary"
    ff = ffmpy.FFmpeg(
